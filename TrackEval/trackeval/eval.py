...
class Evaluator:
    ...
    def evaluate(self, dataset_list, metrics_list):
                                ...
                                if config['PRINT_RESULTS'] and config['PRINT_ONLY_COMBINED']:
                                    ...
                                    if not dont_print:
                                        metric.print_table({'COMBINED_SEQ': table_res['COMBINED_SEQ']},
                                                           tracker_display_name, c_cls,True)
                                elif config['PRINT_RESULTS']:
                                    #print(table_res)
                                    if metric_name == 'HOTA':
                                        output_HOTA,seq_HOTA = metric.print_table(table_res, tracker_display_name, c_cls,True)
                                    else:
                                        metric.print_table(table_res, tracker_display_name, c_cls,True)
                                else:
                                    if metric_name == 'HOTA':
                                        output_HOTA,seq_HOTA = metric.print_table(table_res, tracker_display_name, c_cls,False)
        ...
        return output_res, output_HOTA,seq_HOTA 
